...
def analyze_domlog_inventory(
    ...
    if all_anomalies:
        ...
        # AISO-210: structured fix library — logrotate + ModSecurity rule.
        # Renderer orders by scope (app_config → waf → ...) and risk.
        d7 = Finding(
            module="domlog_inventory",
            severity=sev,
        ...
        findings.append(attach_fixes(d7, lookup_fixes("D7:domlog_anomalies")))
    else:
        findings.append(Finding(
            module="domlog_inventory",
            severity=Severity.INFO,
